...
const ResultSummaryComponent = () => {
  return (
    <div className=" w-[600px] h-[330px] max-mobile:w-full max-mobile:h-[100vh] max-mobile:rounded-none rounded-2xl flex flex-row max-mobile:flex-col gap-2 font-hankenGrotesk shadow-2xl max-mobile:gap-0 max-mobile:shadow-none max-mobile:top-0">
